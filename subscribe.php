...
<div>
  <form method="POST" action="https://adamburucs.activehosted.com/proc.php" id="_form_1_" class="_form _form_1 _inline-form _inline-style _dark" novalidate>
    ...
    <div class="_form-content">
      <div class="_form_element _x50371750 _inline-style _clear" >
        <div class="_form-title">
          Letöltés
        </div>
      </div>
      <div class="_form_element _x31645724 _inline-style _clear" >
        <div class="_html-code">
          <p>
            "Audio Mastering és Mixing könyv" letöltése
          </p>
        </div>
      </div>
      <div class="_form_element _x10673303 _inline-style " >
...
(function() {
  ...
  var form_submit = function(e) {
    ...
    if (validate_form()) {
      ...
      _load_script('https://adamburucs.activehosted.com/proc.php?' + serialized + '&jsonp=true');
    }
    return false;
  };
