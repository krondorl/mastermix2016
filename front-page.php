	...
	<main id="main" class="site-main">
      <div class="clearfix">
            ...
            <div class="col-sm-8 nopadding">
              <h2 class="learn-better-sound">
              Tanuld meg, hogy készíts <em>jobb hangzást!</em></h2>
              <h3 class="free-book">Ingyenes, átfogó könyv a Mixingről és Masteringről</h3>
              <p>
              A mű hangmérnöki szempontból (final mix, mixdown, "végső keverés", "lekeverés") közelít a keveréshez.
              Töltsd le a 72 oldalas <strong>INGYENES</strong> könyvet és kezdj gyakorolni!</p>
