...
<div id="primary" class="content-area">
    ...
    <div class="clearfix">
      <div class="col-md-4">
        <a class="" href="https://www.dropbox.com/s/3ek9l2hptexql0m/burucs_adam-audio_mastering_es_mixing_2015-10-30-c.zip?dl=0" target="_blank"><img class="book" src="<?php echo get_template_directory_uri(); ?>/../mastermix2016/img/mastering-mixing-konyv-borito.jpg" alt="Audio mastering és mixing könyv borító"></a>
      </div>
      <div class="col-md-8">
        ...
        <p>Töltsd le a könyvet és tanuld meg, hogy készíts jobb hangzást!</p>
   ...
   <div class="clearfix">
    <ul class="col-md-6">
      ...
      <li>Dinamika (compressor, limiter, gate, expander, multi band compressor, de-esser)</li>
      ...
      <li>Emberi tényezők a keverés során: érzelmek, hallás, látás</li>
    ...
    <ul class="col-md-6">
      ...
      <li>Művelődjünk! Válogatott zenék meghallgatása több stílusban</li>
	...
	<div class="clearfix about-section">
      <div class="col-md-4">
        ...
        <p>A könyv szerzője és az oldal alapítója. 2013 óta ír angol nyelvű <a href="http://tutsplus.com/authors/adam-burucs" target="_blank">szakmai cikkeket</a>. Karrierje zongoraleckékkel kezdődött, majd jött a <a href="http://adamfiregate.com/" target="_blank">zeneszerzés</a>, hangszín-tervezés és a <a href="https://www.facebook.com/afmastering/" target="_blank">hangmérnöki tevékenységek</a>.</p>
      </div>
      <div class="col-md-4">
