      ...
      <div class="clearfix">
        <div class="clearfix">
          <div class="pull-left col-xs-5 col-sm-3 noleftpad">
            <img class="book" src="<?php echo get_template_directory_uri(); ?>/../mastermix2016/img/mastering-mixing-konyv-borito-2.jpg?v3" alt="Audio mastering és mixing könyv borító">
          </div>
          <div class="">
            <p>Átfogó könyv a mixingről és masteringről, hangmérnöki szempontból (final mix, mixdown, "végső keverés", "lekeverés").
            Töltsd le a 72 oldalas <strong>INGYENES</strong> könyvet (<em>5000 Ft értékben</em>) és tanuld meg, hogy készíts <em>jobb hangzást!</em></p>
